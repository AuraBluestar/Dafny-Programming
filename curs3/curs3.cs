// Dafny program curs3.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\mirel\OneDrive\Desktop\FACULTATE\vdpd\curs3\curs3.dfy
// curs3.dfy

method minMax(x: int, y: int)
...
namespace _module {
  ...
  public partial class __default {
    public static void minMax(BigInteger x, BigInteger y, out BigInteger min, out BigInteger max)
    {
      min = BigInteger.Zero;
      max = BigInteger.Zero;
      if ((x) < (y)) {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _out0;
      BigInteger _out1;
      __default.minMax(new BigInteger(13), new BigInteger(14), out _out0, out _out1);
      _0_min = _out0;
      _1_max = _out1;
      Dafny.Helpers.Print((_0_min));
      Dafny.Helpers.Print((_1_max));
    }
  }
