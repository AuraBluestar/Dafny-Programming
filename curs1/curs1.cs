// Dafny program curs1.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\mirel\OneDrive\Desktop\curs1.dfy
// curs1.dfy
...
method linearSearch(a: array<int>, key: int) returns (pos: int)
  ensures pos == -1 ==> forall i: int {:trigger a[i]} :: 0 <= i < a.Length ==> a[i] != key
  ...
  decreases a, key
{
  ...
  while i < a.Length
    ...
    invariant forall j: int {:trigger a[j]} :: 0 <= j < i ==> a[j] != key
...
method binarySearch(a: array<int>, key: int) returns (pos: int)
  requires forall i: int {:trigger a[i]} :: forall j: int {:trigger a[j]} :: 0 <= i < j < a.Length ==> a[i] <= a[j]
  ensures pos == -1 ==> forall i: int {:trigger a[i]} :: 0 <= i < a.Length ==> a[i] != key
  ensures pos != -1 ==> 0 <= pos < a.Length && a[pos] == key
  decreases a, key
{
  ...
  while l <= r
    ...
    invariant forall i: int {:trigger a[i]} :: 0 <= i < l ==> a[i] < key
    invariant forall i: int {:trigger a[i]} :: r < i < a.Length ==> a[i] > key
    decreases r - l
  {
    var mid := (l + r) / 2;
    if a[mid] == key {
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static BigInteger computeAbs2(BigInteger x)
    {
      BigInteger r = BigInteger.Zero;
      if ((x).Sign == -1) {
        r = (BigInteger.Zero) - (x);
    ...
    public static BigInteger f(BigInteger n) {
      if ((n) <= (BigInteger.One)) {
        ...
        return (__default.f((n) - (BigInteger.One))) + (__default.f((n) - (new BigInteger(2))));
      }
    }
    public static BigInteger fibImp(BigInteger n)
    {
      BigInteger r = BigInteger.Zero;
      BigInteger _0_a;
      _0_a = BigInteger.One;
    ...
    public static BigInteger fibRec(BigInteger n)
    {
      ...
      if ((n).Sign == 0) {
        ...
        BigInteger _0_x;
        BigInteger _out0;
        _out0 = __default.fibRec((n) - (BigInteger.One));
        _0_x = _out0;
        BigInteger _1_y;
        BigInteger _out1;
        _out1 = __default.fibRec((n) - (new BigInteger(2)));
        _1_y = _out1;
        r = (_0_x) + (_1_y);
        return r;
      }
    ...
    public static BigInteger linearSearch(BigInteger[] a, BigInteger key)
    {
    ...
    public static BigInteger binarySearch(BigInteger[] a, BigInteger key)
    {
      ...
      BigInteger _1_r;
      _1_r = (new BigInteger((a).Length)) - (BigInteger.One);
      while ((_0_l) <= (_1_r)) {
        BigInteger _2_mid;
        _2_mid = Dafny.Helpers.EuclideanDivision((_0_l) + (_1_r), new BigInteger(2));
        if (((a)[(int)(_2_mid)]) == (key)) {
          pos = _2_mid;
          return pos;
        } else if (((a)[(int)(_2_mid)]) > (key)) {
          _1_r = (_2_mid) - (BigInteger.One);
        } else if (((a)[(int)(_2_mid)]) < (key)) {
          _0_l = (_2_mid) + (BigInteger.One);
        } else {
        }
      }
      pos = new BigInteger(-1);
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      BigInteger _0_x5;
      BigInteger _out0;
      _out0 = __default.fibRec(new BigInteger(5));
      _0_x5 = _out0;
      BigInteger _1_y5;
      BigInteger _out1;
      _out1 = __default.fibImp(new BigInteger(5));
      _1_y5 = _out1;
      BigInteger _2_x7;
      BigInteger _out2;
      _out2 = __default.fibRec(new BigInteger(7));
      _2_x7 = _out2;
      BigInteger _3_y7;
      BigInteger _out3;
      _out3 = __default.fibImp(new BigInteger(7));
      _3_y7 = _out3;
      Dafny.Helpers.Print((_0_x5));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_y5));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_x7));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_3_y7));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
