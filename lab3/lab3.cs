...
// Command-line arguments: run --no-verify c:\Users\mirel\OneDrive\Desktop\FACULTATE\vdpd\lab3\lab3.dfy
// lab3.dfy
  ...
  public partial class __default {
    public static bool ContainsDuplicates(BigInteger[] arr)
    {
      ...
      for (BigInteger _1_i = BigInteger.Zero; _1_i < _hi0; _1_i++) {
        BigInteger _hi1 = (_0_n) - (BigInteger.One);
        for (BigInteger _2_j = (_1_i) + (BigInteger.One); _2_j < _hi1; _2_j++) {
          if (((arr)[(int)(_1_i)]) == ((arr)[(int)(_2_j)])) {
            res = true;
            return res;
          }
        }
    ...
    public static bool ContainsDuplicatesGeneric<__T>(__T[] arr)
    {
      ...
      for (BigInteger _1_i = BigInteger.Zero; _1_i < _hi0; _1_i++) {
        BigInteger _hi1 = (_0_n) - (BigInteger.One);
        for (BigInteger _2_j = (_1_i) + (BigInteger.One); _2_j < _hi1; _2_j++) {
          if (object.Equals((arr)[(int)(_1_i)], (arr)[(int)(_2_j)])) {
            res = true;
            return res;
          }
        }
    ...
    public static _IMaybe<_System._ITuple2<BigInteger, BigInteger>> ContainsDuplicatesMaybe(BigInteger[] arr)
    {
      ...
      for (BigInteger _1_i = BigInteger.Zero; _1_i < _hi0; _1_i++) {
        ...
        for (BigInteger _2_j = (_1_i) + (BigInteger.One); _2_j < _hi1; _2_j++) {
          if (((arr)[(int)(_1_i)]) == ((arr)[(int)(_2_j)])) {
            result = _module.Maybe<_System._ITuple2<BigInteger, BigInteger>>.create_Just(_System.Tuple2<BigInteger, BigInteger>.create(_1_i, _2_j));
            return result;
          }
        }
      }
    ...
    public static void swapinArray(BigInteger[] a, BigInteger x, BigInteger y)
    {
      BigInteger _0_t;
      _0_t = (a)[(int)(x)];
      (a)[(int)((x))] = (a)[(int)(y)];
    ...
    {
      BigInteger[] _0_array1;
      BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(10), "array size exceeds memory limit")];
      _0_array1 = _nw0;
      (_0_array1)[(int)((BigInteger.Zero))] = BigInteger.One;
      (_0_array1)[(int)((BigInteger.One))] = BigInteger.One;
      (_0_array1)[(int)((new BigInteger(2)))] = new BigInteger(2);
      (_0_array1)[(int)((new BigInteger(3)))] = BigInteger.One;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Array înainte de swap: ")).ToVerbatimString(false));
      BigInteger _1_i;
      _1_i = BigInteger.Zero;
      while ((_1_i) < (new BigInteger((_0_array1).Length))) {
        Dafny.Helpers.Print(((_0_array1)[(int)(_1_i)]));
        _1_i = (_1_i) + (BigInteger.One);
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      bool _2_hasDuplicates1;
      bool _out0;
      _out0 = __default.ContainsDuplicates(_0_array1);
      _2_hasDuplicates1 = _out0;
      Dafny.Helpers.Print((_2_hasDuplicates1));
      bool _out1;
      _out1 = __default.ContainsDuplicatesGeneric<BigInteger>(_0_array1);
      _2_hasDuplicates1 = _out1;
      Dafny.Helpers.Print((_2_hasDuplicates1));
      __default.swapinArray(_0_array1, BigInteger.Zero, new BigInteger(2));
      BigInteger _3_ii;
      _3_ii = BigInteger.Zero;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      while ((_3_ii) < (new BigInteger((_0_array1).Length))) {
        Dafny.Helpers.Print(((_0_array1)[(int)(_3_ii)]));
        _3_ii = (_3_ii) + (BigInteger.One);
      }
    }
  }
