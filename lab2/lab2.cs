// Dafny program lab2.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\mirel\OneDrive\Desktop\FACULTATE\vdpd\lab2\lab2.dfy
// lab2.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static BigInteger sum(_IList l) {
    ...
    TAIL_CALL_START: ;
      ...
      }
      {
        ...
        _IList _2_tail = _source0.dtor_tail;
        return (BigInteger.One) + (__default.sum(_2_tail));
      }
    }
    public static bool allPozitive(_IList l) {
      _IList _source0 = l;
      {
        if (_source0.is_Nil) {
          return true;
      ...
      {
        BigInteger _0_head = _source0.dtor_head;
        _IList _1_tail = _source0.dtor_tail;
        return ((_0_head).Sign == 1) && (__default.allPozitive(_1_tail));
      }
    }
    public static bool all(Dafny.ISequence<BigInteger> l, Func<BigInteger, bool> p)
    {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<BigInteger>, Func<BigInteger, bool>, bool>>((_0_l, _1_p) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_l).Count)), true, (((_forall_var_0) => {
        BigInteger _2_i = (BigInteger)_forall_var_0;
        return !(((_2_i).Sign != -1) && ((_2_i) < (new BigInteger((_0_l).Count)))) || (Dafny.Helpers.Id<Func<BigInteger, bool>>(_1_p)((_0_l).Select(_2_i)));
      }))))(l, p);
    }
    public static _IList map1(_IList l, Func<BigInteger, BigInteger> f)
    {
      _IList _source0 = l;
      {
        if (_source0.is_Nil) {
          return _module.List.create_Nil();
        }
      }
      {
        BigInteger _0_head = _source0.dtor_head;
        _IList _1_tail = _source0.dtor_tail;
        return _module.List.create_Cons(Dafny.Helpers.Id<Func<BigInteger, BigInteger>>(f)(_0_head), __default.map1(_1_tail, f));
      }
    }
    public static _IList filter(_IList l, Func<BigInteger, bool> f)
    {
      _IList _source0 = l;
      {
        if (_source0.is_Nil) {
      ...
      }
      {
        BigInteger _0_head = _source0.dtor_head;
        _IList _1_tail = _source0.dtor_tail;
        if (Dafny.Helpers.Id<Func<BigInteger, bool>>(f)(_0_head)) {
          return _module.List.create_Cons(_0_head, __default.filter(_1_tail, f));
        } else {
          return __default.filter(_1_tail, f);
        }
      }
    }
    public static BigInteger sumSeq(Dafny.ISequence<BigInteger> s1) {
      BigInteger _0___accumulator = BigInteger.Zero;
    TAIL_CALL_START: ;
      if ((new BigInteger((s1).Count)).Sign == 0) {
        return (BigInteger.Zero) + (_0___accumulator);
      } else {
        _0___accumulator = (_0___accumulator) + ((s1).Select(BigInteger.Zero));
        Dafny.ISequence<BigInteger> _in0 = (s1).Drop(BigInteger.One);
        s1 = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static Dafny.ISequence<BigInteger> ListToSeq(_IList l) {
      Dafny.ISequence<BigInteger> _0___accumulator = Dafny.Sequence<BigInteger>.FromElements();
    TAIL_CALL_START: ;
      Dafny.ISequence<BigInteger> _1_s = Dafny.Sequence<BigInteger>.FromElements();
      _IList _source0 = l;
      {
        if (_source0.is_Nil) {
          return _1_s;
      ...
      }
      {
        ...
        _IList _3_tail = _source0.dtor_tail;
        return Dafny.Sequence<BigInteger>.Concat(Dafny.Sequence<BigInteger>.FromElements(_2_head), __default.ListToSeq(_3_tail));
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.ISequence<BigInteger> _0_s1;
      _0_s1 = Dafny.Sequence<BigInteger>.FromElements(BigInteger.One, new BigInteger(2), new BigInteger(3));
      Dafny.Helpers.Print((__default.sumSeq(_0_s1)));
      _IList _1_lista;
      _1_lista = _module.List.create_Cons(BigInteger.One, _module.List.create_Cons(new BigInteger(2), _module.List.create_Cons(new BigInteger(3), _module.List.create_Nil())));
      Dafny.ISequence<BigInteger> _2_s2;
      _2_s2 = __default.ListToSeq(_1_lista);
      Dafny.Helpers.Print((_2_s2));
    }
  }

  public interface _IList {
    bool is_Nil { get; }
    bool is_Cons { get; }
    BigInteger dtor_head { get; }
    _IList dtor_tail { get; }
    _IList DowncastClone();
  }
  public abstract class List : _IList {
    public List() {
    }
    private static readonly _IList theDefault = create_Nil();
    public static _IList Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_IList> _TYPE = new Dafny.TypeDescriptor<_IList>(List.Default());
    public static Dafny.TypeDescriptor<_IList> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IList create_Nil() {
      return new List_Nil();
    }
    public static _IList create_Cons(BigInteger head, _IList tail) {
      return new List_Cons(head, tail);
    }
    public bool is_Nil { get { return this is List_Nil; } }
    public bool is_Cons { get { return this is List_Cons; } }
    public BigInteger dtor_head {
      get {
        var d = this;
        return ((List_Cons)d)._head;
      }
    }
    public _IList dtor_tail {
      get {
        var d = this;
        return ((List_Cons)d)._tail;
      }
    }
    public abstract _IList DowncastClone();
  }
  public class List_Nil : List {
    public List_Nil() : base() {
    }
    public override _IList DowncastClone() {
      if (this is _IList dt) { return dt; }
      return new List_Nil();
    }
    public override bool Equals(object other) {
      var oth = other as List_Nil;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public class List_Cons : List {
    public readonly BigInteger _head;
    public readonly _IList _tail;
    public List_Cons(BigInteger head, _IList tail) : base() {
      this._head = head;
      this._tail = tail;
    }
    public override _IList DowncastClone() {
      if (this is _IList dt) { return dt; }
      return new List_Cons(_head, _tail);
    }
    public override bool Equals(object other) {
      var oth = other as List_Cons;
      return oth != null && this._head == oth._head && object.Equals(this._tail, oth._tail);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
