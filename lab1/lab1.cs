// Dafny program lab1.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\mirel\OneDrive\Desktop\FACULTATE\vdpd\lab1.dfy
// lab1.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger funAbs(BigInteger x) {
      if ((x).Sign != -1) {
        return x;
      } else {
    ...
    public static BigInteger computeAbs(BigInteger x)
    {
    ...
    public static BigInteger max2F(BigInteger x, BigInteger y)
    {
      if ((x) > (y)) {
        return x;
      } else {
    ...
    public static BigInteger max2(BigInteger x, BigInteger y)
    {
      BigInteger r = BigInteger.Zero;
      if ((x) > (y)) {
        r = x;
    ...
    public static BigInteger computeFib(BigInteger n)
    {
      ...
      if ((n).Sign == 0) {
        ...
        BigInteger _0_x;
        BigInteger _out0;
        _out0 = __default.computeFib((n) - (BigInteger.One));
        _0_x = _out0;
        BigInteger _1_y;
        BigInteger _out1;
        _out1 = __default.computeFib((n) - (new BigInteger(2)));
        _1_y = _out1;
        r = (_0_x) + (_1_y);
        return r;
      }
    ...
    public static BigInteger search(BigInteger[] a, BigInteger key)
    {
      BigInteger r = BigInteger.Zero;
      BigInteger _0_i;
    ...
    public static BigInteger minArray(BigInteger[] a)
    {
      ...
      _0_i = BigInteger.Zero;
      BigInteger _1_min;
      _1_min = new BigInteger(9999);
      while ((_0_i) < (new BigInteger((a).Length))) {
        if (((a)[(int)(_0_i)]) < (_1_min)) {
          _1_min = (a)[(int)(_0_i)];
        }
        _0_i = (_0_i) + (BigInteger.One);
      }
    ...
    public static BigInteger maxArray(BigInteger[] a)
    {
      ...
      _0_i = BigInteger.Zero;
      BigInteger _1_max;
      _1_max = new BigInteger(-9999);
      while ((_0_i) < (new BigInteger((a).Length))) {
        if (((a)[(int)(_0_i)]) > (_1_max)) {
          _1_max = (a)[(int)(_0_i)];
        }
        _0_i = (_0_i) + (BigInteger.One);
      }
    ...
    public static BigInteger searchInv(BigInteger[] a, BigInteger key)
    {
      BigInteger r = BigInteger.Zero;
      BigInteger _0_i;
      _0_i = (new BigInteger((a).Length)) - (BigInteger.One);
      while ((_0_i).Sign != -1) {
        if (((a)[(int)(_0_i)]) == (key)) {
          r = _0_i;
          r = r;
    ...
    public static BigInteger secondMax(BigInteger[] a)
    {
      BigInteger r = BigInteger.Zero;
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      BigInteger _1_max1;
      _1_max1 = new BigInteger(-9999);
      BigInteger _2_max2;
      _2_max2 = new BigInteger(-9999);
      while ((_0_i) < (new BigInteger((a).Length))) {
        if (((a)[(int)(_0_i)]) > (_1_max1)) {
          _2_max2 = _1_max1;
          _1_max1 = (a)[(int)(_0_i)];
        } else if (((a)[(int)(_0_i)]) > (_2_max2)) {
          _2_max2 = (a)[(int)(_0_i)];
        }
        _0_i = (_0_i) + (BigInteger.One);
      }
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      BigInteger _0_x;
      BigInteger _out0;
      _out0 = __default.computeAbs(new BigInteger(-5));
      _0_x = _out0;
      BigInteger _1_y;
      BigInteger _out1;
      _out1 = __default.max3(BigInteger.One, new BigInteger(7), new BigInteger(5));
      _1_y = _out1;
      BigInteger _2_z;
      _2_z = __default.max2F(new BigInteger(-1), new BigInteger(6));
      BigInteger _3_t;
      BigInteger _out2;
      _out2 = __default.computeFib(new BigInteger(7));
      _3_t = _out2;
      BigInteger[] _4_a;
      ...
      BigInteger _rhs1 = new BigInteger(9);
      BigInteger _rhs2 = new BigInteger(27);
      BigInteger _rhs3 = new BigInteger(9);
      BigInteger _rhs4 = new BigInteger(-11);
      BigInteger[] _lhs0 = _4_a;
      BigInteger _lhs1 = BigInteger.Zero;
      BigInteger[] _lhs2 = _4_a;
      BigInteger _lhs3 = BigInteger.One;
      BigInteger[] _lhs4 = _4_a;
      BigInteger _lhs5 = new BigInteger(2);
      BigInteger[] _lhs6 = _4_a;
      BigInteger _lhs7 = new BigInteger(3);
      BigInteger[] _lhs8 = _4_a;
      ...
      BigInteger _5_x1;
      BigInteger _out3;
      _out3 = __default.search(_4_a, new BigInteger(27));
      _5_x1 = _out3;
      BigInteger _6_x2;
      BigInteger _out4;
      _out4 = __default.searchInv(_4_a, new BigInteger(27));
      _6_x2 = _out4;
      BigInteger _7_x3;
      BigInteger _out5;
      _out5 = __default.minArray(_4_a);
      _7_x3 = _out5;
      BigInteger _8_x4;
      BigInteger _out6;
      _out6 = __default.maxArray(_4_a);
      _8_x4 = _out6;
      BigInteger _9_x5;
      BigInteger _out7;
      _out7 = __default.secondMax(_4_a);
      _9_x5 = _out7;
      Dafny.Helpers.Print((_0_x));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_y));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_z));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_3_t));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_5_x1));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_6_x2));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_7_x3));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_8_x4));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_9_x5));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
